...
> Paste this entire block into VS Code Copilot Chat at the start of your session, or save it as `.github/copilot-instructions.md` in your repo root so Copilot reads it automatically every time.
...
*(I'll fill this in each session — update before pasting)*
